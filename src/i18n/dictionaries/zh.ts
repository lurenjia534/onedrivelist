const zh = {
  ...
  "folder.dialog.title": "创建新文件夹",
  "folder.dialog.subtitle": "为内容整理一个全新的空间。",
  ...
  "rename.dialog.title": "重命名项目",
  "rename.dialog.subtitle": "换个更合适的名字，让内容更易管理。",
  "rename.name.label": "新的名称",
  "rename.name.placeholder": "输入新的名称",
  "rename.cancel": "取消",
  "rename.submit": "保存",
  "rename.validation.required": "请输入新的名称。",
  "rename.validation.unchanged": "新名称需要与当前名称不同。",
  "logout": "退出登录",
  "logout.loading": "正在退出…",
