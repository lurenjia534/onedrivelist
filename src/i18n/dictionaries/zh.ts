const zh = {
  ...
  "upload.queue.empty": "暂无上传任务。",
  "upload.status.pending": "等待开始",
  "upload.status.uploading": "正在上传 {progress}%",
  "upload.status.success": "已完成",
  "upload.status.error": "失败：{message}",
  ...
  "bulk.select.enter": "批量选择",
  "bulk.select.exit": "退出批量选择",
  "bulk.select.all": "全选",
  "bulk.select.none": "取消全选",
  "bulk.select.clear": "清除选择",
  "bulk.select.item": "选择 {name}",
  "bulk.selected.count": "已选择 {count} 项",
  "bulk.delete.action": "删除选中",
  "bulk.delete.deleting": "正在批量删除…",
  "bulk.delete.error": "以下项目删除失败：{names}",
  "bulk.delete.dialog.title": "批量删除选中的项目？",
  "bulk.delete.dialog.subtitle": "这些项目将被移动到 OneDrive 回收站，可在其中恢复。",
  "bulk.delete.dialog.summary": "将删除 {count} 个项目。",
  "bulk.delete.dialog.preview": "即将删除：{names}",
  "bulk.delete.dialog.preview.more": "即将删除：{shown} 等 {count} 个项目",
  "bulk.delete.cancel": "取消",
  "bulk.delete.confirm": "删除",
  "logout": "退出登录",
  "logout.loading": "正在退出…",
